      ...
      <div className="shadow">
        ...
        <div className="details bg-white dark:bg-invoicify-03 p-6">
          <div className="md:flex md:justify-between md:mb-5">
            ...
            <div className="w-[100px] whitespace-nowrap flex justify-center items-center flex-wrap my-[30px] md:my-0 text-body text-invoicify-07">
